...
const servicesData = {
  b2b: {
    ...
    customers: ['Healthcare & Medical devices', 'FMCG', 'Retail & e-commerce', 'Electronics', 'Enterprise shippers'],
    color: '#0A1F44',
    cta: 'Get a B2B Quote',
  },
  b2c: {
    badge: 'B2C',
    image: 'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=1800&auto=format&fit=crop&q=80',
    ...
    customers: ['Online stores', 'Marketplaces', 'Retail chains', 'Food & beverage brands', 'Subscription box companies'],
    color: '#1a56db',
    cta: 'Get a B2C Quote',
  },
  c2c: {
    badge: 'C2C',
    image: 'https://images.unsplash.com/photo-1512428559087-560fa5ceab42?w=1800&auto=format&fit=crop&q=80',
    ...
    features: [
      { title: 'Instant booking via app', desc: 'Book in seconds — no account manager needed' },
      { title: 'Always-on EV fleet', desc: 'Your parcel moves green, guaranteed' },
      { title: 'Live parcel tracking', desc: 'Real-time visibility from pickup to drop-off' },
      { title: 'CO₂ savings per booking', desc: 'See your environmental impact instantly' },
      { title: 'ePOD & dispute resolution', desc: 'Digital proof, no "lost parcel" arguments' },
      { title: 'Transparent pricing', desc: 'No surprise charges — what you see is what you pay' },
    ],
    customers: ['Individual consumers', 'SME merchants', 'Online resellers', 'Marketplace sellers', 'Small retail businesses'],
    color: '#047857',
  ...
  platform: {
    ...
    features: [
      ...
      { title: 'Real-time CO₂ tracking', desc: 'First in Singapore — live carbon ledger' },
      { title: 'SLA enforcement & analytics', desc: 'Enterprise-grade audit-ready reports' },
    ],
    customers: ['SME fleet operators', 'Courier & logistics companies', '3PLs', 'Enterprise shippers', 'Field-service operations'],
    color: '#5521b5',
    cta: 'Request a Demo',
  },
  rental: {
    badge: 'Rental',
    image: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=1800&auto=format&fit=crop&q=80',
    ...
    features: [
      { title: 'Half-day vehicle hire', desc: 'Perfect for short-term delivery needs' },
      { title: 'Full-day vehicle hire', desc: 'All-day capacity with EV efficiency' },
      { title: 'Monthly EV van rental', desc: 'Predictable costs for growing teams' },
      { title: 'On-call driver support', desc: 'Optional driver available on request' },
      { title: 'Fluid fleet scaling', desc: 'Scale up or down as your business needs change' },
      { title: '100% Electric fleet', desc: 'Zero emissions, full compliance' },
    ],
    customers: ['Growing SMEs', 'Event companies', 'Moving services', 'Retail businesses', 'Pop-up operations'],
    color: '#b45309',
    ...
    return (
      <div style={{ background: '#F6F5F0' }}>
        ...
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-8">
          <h2 className="text-3xl font-black text-[#0A1F44] mb-4">Service not found</h2>
          <Link to="/" className="px-6 py-3 rounded-xl bg-[#0A1F44] text-yellow-400 font-bold">
            ← Back to Home
          </Link>
        </div>
        <Footer />
      ...
      <section className="pt-16 pb-0 relative overflow-hidden">
        <div className="relative h-[480px] w-full overflow-hidden">
          ...
          <div className="absolute inset-0"
            style={{ background: `linear-gradient(135deg, ${service.color}f0 0%, ${service.color}aa 50%, ${service.color}55 100%)` }} />
          ...
          <div className="absolute inset-0 flex items-end px-6 lg:px-16 pb-14">
            <div className="max-w-5xl mx-auto w-full">
              ...
              <div>
                <span className="inline-block text-[11px] font-black tracking-[3px] uppercase px-3 py-1.5 rounded-full mb-4"
                ...
                <a href="/#contact">
                  <button className="px-8 py-4 rounded-2xl font-black text-base transition-all hover:-translate-y-0.5 hover:shadow-xl"
                    style={{ background: '#FFD600', color: '#0A1F44' }}>
                    {service.cta} →
                  </button>
                </a>
      ...
      <section className="py-16 px-6 lg:px-10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {service.features.map((f, i) => (
                  <div key={i} className="flex gap-3 items-start p-4 rounded-2xl"
                    ...
                    <div>
                      <p className="font-bold text-[#0A1F44] text-sm">{f.title}</p>
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Who it's for */}
            <div className="bg-white rounded-3xl p-7 border border-black/6"
              style={{ boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            <div className="rounded-3xl p-7 text-center"
              ...
              <a href="/#contact">
                <button className="w-full py-3 rounded-2xl font-black text-sm transition-all hover:-translate-y-0.5"
                  style={{ background: '#FFD600', color: '#0A1F44' }}>
                  {service.cta} →
                </button>
              </a>
                ...
                {Object.entries(servicesData)
                  ...
                  .map(([key, s]) => (
                    <Link key={key} to={`/services/${key}`}
                      className="flex items-center gap-2 text-sm font-semibold text-[#0A1F44] hover:text-yellow-600 transition-colors py-1">
