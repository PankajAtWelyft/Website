...
export default function TotalImpactPanel({ data: dashboardData = DEFAULT_CO2_SAVINGS_VIEW }) {
  ...
  return (
    <div className="w-full h-full rounded-xl  bg-[#F6F5F0] p-4 sm:p-5 md:p-6" style={{ borderColor: palette.co2Emission }}>
          ...
          return (
            <div key={idx} className="flex items-center gap-4 py-3 sm:py-4">
              ...
              style={{ background: `${palette.co2Emission}33` }}>
                <Icon className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: palette.co2Emission }} strokeWidth={2} />
              </div>
