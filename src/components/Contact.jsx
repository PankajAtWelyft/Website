...
const Contact = () => {
  return (
    <>
      <section id="contact" className="scroll-mt-24 flex justify-center bg-[#F6F5F0] h-auto relative overflow-hidden">
        <div className="mx-4 lg:mx-7 max-w-4xl min-h-[420px] sm:min-h-[500px] lg:min-h-[500px] flex-col text-center py-10 sm:py-14 lg:py-16 px-4 sm:px-6 lg:px-10 mb-10 rounded-[28px] bg-[#0A1F44]">
