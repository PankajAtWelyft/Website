        ...
        <div className="max-w-7xl mx-auto flex items-center gap-32 px-10">
          <div className="w-1/2">
            ...
            <p className="text-xl  text-gray-600 leading-relaxed mt-7">
              When your people depend on it, so do we. From onboarding day one
              to long-term planning, Welyft delivers without a beat dropped — at
              the scale and speed your business demands.
            </p>
          ...
          <div className="w-1/2">
            <img
              src={serv}
              className=" w-full rounded-3xl h-150 object-cover hover:scale-105 transition-all duration-500"
              alt=""
            />
          </div>
        </div>
